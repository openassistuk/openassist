...
For Code of Conduct concerns, contact repository maintainers via GitHub
(@openassistuk). If you need a non-public channel, use:

- `https://github.com/openassistuk/openassist/security/advisories/new`

Please include links, screenshots, timestamps, and any other relevant context.
