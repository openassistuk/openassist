...
Runtime only executes tool calls that were actually advertised for the active session, and outbound delivery now degrades missing staged files into explicit notes instead of silent adapter failures.
